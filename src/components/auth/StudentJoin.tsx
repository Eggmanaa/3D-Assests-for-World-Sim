    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-blue-400/30">
          ...
          <h2 className="text-3xl font-bold text-white text-center mb-2">Join a Class</h2>
          <p className="text-gray-300 text-center mb-6">Enter your teacher's invite code to get started.</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent uppercase"
                  placeholder="ABC123"
                  required
                  maxLength={6}
                />
